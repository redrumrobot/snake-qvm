...
typedef struct
{
  ...
  qboolean          invisible;       // for being invisible on the server - BOO!
...
extern  vmCvar_t  g_maxTKs;
extern  vmCvar_t  g_maxTKTime;
...
extern  vmCvar_t  g_adminReports;
extern  vmCvar_t  g_adminTempBan;
extern  vmCvar_t  g_adminMaxBan;
extern  vmCvar_t  g_adminTempSpec;
extern  vmCvar_t  g_Bubbles;
extern  vmCvar_t  g_FireWorks;
extern  vmCvar_t  g_noAbusableCMDs;
extern  vmCvar_t  g_minNoRegisterLevel;
extern  vmCvar_t  g_maxNoRegisterLevel;
extern  vmCvar_t  g_NoRegisterLevels;
